...
public class ProyectoComercial extends Proyecto {
    ...
    public ProyectoComercial(Freelance freelance, String nombre, String empresa, String precio, String estado, String descripcion, Date fechaInicio, Date fechaEntrega) {
