...
public class Fotografo extends Freelance {
    ...
    public Fotografo(String nombreMarca, String modeloCamara, String nombre, String contraseña, int edad, char genero, double dinero, String ciudad, String telefono, String id, String correo) {
    ...
    public String toString() {
        return "Fotografo{" + "proyectospubli=" + proyectospubli + ", nombreMarca=" + nombreMarca + ", modeloCamara=" + modeloCamara + '}';
    }
